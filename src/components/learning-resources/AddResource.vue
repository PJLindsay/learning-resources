<template>
  ...
  >
    <template #default>
      ...
      <p>Make sure each input has at least 1 character</p>
    </template>
    <template #actions>
...
<script>
export default {
  inject: ['addResource'], // inject method provided in TheResources.vue
  data() {
    return {
  ...
  methods: {
    ...
    submitData() {
      ...
      // use method injected from TheResources.vue
